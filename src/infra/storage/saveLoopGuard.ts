/**
 * 基础设施层存储防回环守卫 (SaveLoopGuard)
 * 职责：聚合管理本地磁盘持久化写盘状态、内容指纹比对与异步事件防护窗，消除外部文件监听的回环竞态
 */
export class SaveLoopGuard {
...
export const saveLoopGuard = new SaveLoopGuard();

// 别名兼容
export const syncCoordinator = saveLoopGuard;
export const syncService = saveLoopGuard;
export { SaveLoopGuard as SyncCoordinator, SaveLoopGuard as SyncService };
